    ...
    <div className={styles.info}>
      ...
      <p>
        {{
          ...
          'alarming': 'Ваше психическое и эмоциональное состояние под угрозой быстрого ухудшения, поэтому мы подготовили для вас индивидуальный план для улучшения ментального здоровья.',
          'low': 'Очень велик риск ухудшения эмоционального состояния, поэтому мы подготовили для вас индивидуальный план для улучшения  ментального здоровья.',
